...
import pasa.cbentley.byteobjects.utils.ByteObjectUtilz;
import pasa.cbentley.byteobjects.utils.ValuesInArrayReader;
...
/**
 * The mighty ByteObject encapsulate a byte array and one offset. All {@link ByteObjectImmutable} are defined
 ...
 * <br>
 * <br>
 * Whereas Java uses package and class name for typing, {@link ByteObjectImmutable} uses a single byte.
 * However when the FLAG sub type is set, typing check first byte after the size
 * or 
 * <li>parametrized field access
 * 
 * completely unrelated and put in {@link ByteObjectImmutable} array.
 * 
 * See ByteObject discussion.
 * 
 * Allows for 254 base type.
 * 
 * Every module has its own implementation of the {@link ByteObjectImmutable}.
 * It overrides and implements its own case of for its types for
 * <li> {@link ByteObjectImmutable#mergeByteObject(ByteObjectImmutable, ByteObjectImmutable)}
 * <li> {@link ByteObjectImmutable#toString(String)}.
 * <br>
 * <br>
 * 
 ...
 * <br>
 * <br>
 * Build a {@link ByteObjectImmutable} from a String representation. This can be seen as the inverse CSV function. 
 * It allows to create a text file manually fill it with human readable text and feed it to the MObject to import
 * From a char array, build the {@link ByteObjectImmutable} as a byte array  
 * <br>
 * Comparator 
 * <br>
 * When storing {@link ByteObjectImmutable} definitions in a {@link IByteStore} what is the Display String?
 * Titled?
 ...
 *
 */
public class ByteObjectImmutable extends ByteObject implements ITechByteObject, IStringable {
   ...
   private final ByteObjectImmutable link1;

   /**
    * Subclass control the init of data,offset 
    * @param mod
    * @param data
    * @throws IllegalArgumentException when mutable cannot fit this immutable definition
    */
   public ByteObjectImmutable(ByteObject mutable) {
      super(mutable.boc);
      int index = mutable.index;
      int size = mutable.getLength();
      int max = Math.min(8, size);
      int long1 = 0;
      //TODO fix it.
      for (int i = 0; i < max; i++) {
         long1 |= (mutable.getByteInt(i) << 8);
      }
      this.data1 = long1;
      this.data2 = 0; //TODO
      this.data3 = 0;
      
      ByteObject subAtIndexNull = mutable.getSubAtIndexNull(0);
      if(subAtIndexNull != null) {
         link1 = new ByteObjectImmutable(subAtIndexNull);
      } else {
         link1 = null; 
      }
   }
   ...
   public ByteObjectImmutable(ByteObjectImmutable immutable) {
      super(immutable.boc);
      this.data1 = immutable.data1;
      this.data2 = immutable.data2;
      this.data3 = immutable.data3;
      this.link1 = immutable.link1;
   }

   /**
    * Append {@link ByteObjectImmutable} in param[] array.
    * <br>
    * <br>
    * Nothing when {@link ByteObjectImmutable} is null.
    * <br>
    * <br>
   ...
   /**
    * Adds non null {@link ByteObjectImmutable}s.
    * <br>
    * <br>
    * 
    * @param bos
    */
   public void addByteObject(ByteObjectImmutable[] bos) {
   ...
   /**
    * Appends {@link ByteObjectImmutable} to the array. Accept nulls.
    * @param bo
    * @return
    */
   public int addByteObjectNull(ByteObjectImmutable bo) {
      immutableCheck();
      if (param == null) {
         param = new ByteObjectImmutable[] { bo };
    ...
    * @param bo
    */
   public void addSub(ByteObjectImmutable bo) {
      addByteObject(bo);
   }
   ...
   /**
    * A Full clone of everything through the serialization {@link ByteObjectImmutable#toByteArray()}
    * If object is in repository, clone with be in the repository.
    * <br>
    * <br>
    * The sub {@link ByteObjectImmutable} in the param array are also cloned.
    * <br>
    * <br>
    * @return
    */
   ...
   public ByteObject cloneCopyHead() {
      ...
      ByteObjectImmutable clone = new ByteObjectImmutable(this);
      clone.setFlagNoVersion(A_OBJECT_OFFSET_2_FLAG, A_OBJECT_FLAG_5_HAS_SUBS, false);
      return clone;
   }

   /**
    * Clone the {@link ByteObjectImmutable} bytes but uses the parameter references
    * <br>
    * <br>
    * @return
    */
   public ByteObject cloneCopyHeadCopyParams() {
      ByteObjectImmutable clone = new ByteObjectImmutable(this);
      if (param != null) {
         clone.param = new ByteObjectImmutable[param.length];
    ...
    */
   public void cloneCopyHeaderFirstBytesFrom(ByteObjectImmutable bo, int len) {
   ...
   /**
    * Link {@link ByteObjectImmutable} bo references to this.
    * <br>
    * Data is not copied!
    * @param bo
    */
   public void cloneRefHeadRefParamsFrom(ByteObjectImmutable bo) {
      data = bo.data;
      index = bo.index;
      param = bo.param;
      boc = bo.boc;
    ...
    * @param len
    */
   public void copyToIndexFromObject(int destIndex, ByteObjectImmutable bo, int srcOffset, int len) {
      System.arraycopy(bo.data, bo.index + srcOffset, data, index + destIndex, len);
   }

   /**
    * Ensures that offset index does not throw an {@link ArrayIndexOutOfBoundsException} on this {@link ByteObjectImmutable}.
    * <br>
    * <br>
    * 
    * @param offset
    ...
    * serialization differences. That means a non-serialized will equals to a serialized {@link ByteObjectImmutable}
    ...
    * @return
    */
   public boolean equals(ByteObjectImmutable p2) {
      ByteObjectImmutable p1 = this;
      if (p1 == null || p2 == null)
         return false;
    ...
    * @return
    */
   public boolean equalsContent(ByteObjectImmutable p2) {
      ByteObjectImmutable p1 = this; //p1 cannot be null
      if (p2 == null)
         return false;
      if (p1.getType() != p2.getType()) {
         return false;
    ...
    * @return
    */
   public boolean equalsToByteArray(ByteObjectImmutable p2) {
      ByteObjectImmutable p1 = this;
      if (p1 == null || p2 == null)
         return false;
      if (p1.getType() != p2.getType()) {
   ...
   /**
    * Creates a copy of the byte array, copying byte to byte {@link ByteObjectImmutable#getLength()}
    * <br>
    * <br>
    * 
    * @return
   ...
   /**
    * Returns the reference of the byte array for this {@link ByteObjectImmutable}.
    * <br>
    * <br>
    * You should not do that with an immutable {@link ByteObjectImmutable} ? TODO
    * 
    * Immutable Checks
    * @return
    */
   ...
   /**
    * Returns the offset in the byte array for this {@link ByteObjectImmutable}.
    * <br>
    * <br>
    * @return
    */
   ...
   /**
    * Get array written with {@link ByteObjectImmutable#setDynBOParamValues(int, int[], int, int)}
    * <br>
    * Treats 0 as a val
    * @param index
    * @return
   ...
   /**
    * Looks up a byte value of {@link ByteObjectImmutable} at offset.
    * <br>
    * Returns
    * <li> 0 for flag = 1;
    * <li> 1 for flag = 2;
   ...
   /**
    * Byte length of the {@link ByteObjectImmutable}.
    * <br>
    * <br>
    ...
    * by {@link ByteObjectImmutable} code for {@link ITechByteObject#A_OBJECT_FLAG_3_VERSIONING}.
    * <br>
    * <br>
    * Sub classes extending {@link ByteObjectImmutable} functionality or maximum stored bytes will sub class this method.
    * <br>
    * <br>
    * @return the number of bytes which make this {@link ByteObjectImmutable}. Includes everything. header,body,trailer.
    */
   ...
   /**
    * Returns the offset of the first byte that does not belong to this {@link ByteObjectImmutable}.
    * <br>
    * <br>
   ...
   /**
    * NumPrefixedChars
    * Similar to {@link ByteObjectImmutable#getValues(int)} but return chars
    * @param index
    * @return
    */
    ...
    * <br>
    * Calling this method pins the {@link ByteObjectImmutable} into memory
    * @return
    */
   public int getRefID() {
   ...
   /**
    * Called only in the context of a serialized {@link ByteObjectImmutable}.
    * <br>
    * <br>
   ...
   /**
    * Returns a flat view of all {@link ByteObjectImmutable}. Breaks any loops.
    * @return
    */
   public ByteObject[] getSubFlatline() {
      IntToObjects ito = new IntToObjects(boc.getUCtx());
      addFlatLine(ito, ito);
      ByteObjectImmutable[] ar = new ByteObjectImmutable[ito.nextempty];
      ito.copy(ar, 0);
      return ar;
   }
   ...
   /**
    * address of {@link ByteObjectImmutable}  in param array is stored at index 
    * @param index
    * @return
    */
   ...
   /**
    * Look up the <code>num</code> th {@link ByteObjectImmutable} of {@link ITechByteObject#A_OBJECT_OFFSET_1_TYPE1}
    * <code>type</code>.
    * <br>
    * Zero based index
    * <br>
   ...
   /**
    * Return all sub encapsulated in a {@link ByteObjectImmutable}/
    * might be null
    * @return
    */
   public ByteObject[] getSubs() {
      if (link1 != null) {
         return new ByteObject[] { link1 };
      }
      return null;
   }
   ...
   public ByteObject[] getSubs(int type) {
      if (param == null) {
         return new ByteObjectImmutable[0];
      }
      int count = 0;
      for (int i = 0; i < param.length; i++) {
         if (param[i] != null && param[i].getType() == type) {
   ...
   /**
    * Get sub {@link ByteObjectImmutable} whose of the given type but its index value of size is equal to value
    * @param type
    * @param index
    * @param size
    * @param value
   ...
   /**
    * Topology of the {@link ByteObjectImmutable} hierarchy.
    * <br>
    * <br>
    * 1st {@link ByteObjectImmutable} in {@link IntToObjects} is the root. The integer value is the number of children.
    * <br>
    * <br>
    * When an object is null, the integer is the position of the {@link ByteObjectImmutable} is the array.
    * <br>
    * <br>
    * 
    * @return
    ...
    * <br>
    * This is used to store variable size array of values inside the {@link ByteObjectImmutable}.
    * @param index
    * @return
    */
   ...
   /**
    * Value that identifies the number of times this {@link ByteObjectImmutable} has been modified. 0 if versioning is disabled.
    * <br>
    * <br>
   ...
   /**
    * True when subs and root {@link ByteObjectImmutable} reference each other
   ...
   public void insertByteObject(ByteObjectImmutable bo, int index) {
    ...
    * <br>
    * 
    * @param merge ACTION other same type as this {@link ByteObjectImmutable}. The parameters of Merge will override those of Root
    * @return
    */
   public ByteObject mergeByteObject(ByteObjectImmutable merge) {
      return boc.getBOModuleManager().mergeByteObject(this, merge);
   }

   /**
    * Read bytes of the {@link ByteObjectImmutable} to the array in parameters.
    * <br>
    ...
    * <br>
    * 
    * {@link ByteObjectImmutable#getValue(int, int)}
    * 
    * @param index
    * @param value
    * @param size
    ...
    * @param bos
    */
   public void setByteObjects(ByteObjectImmutable[] bos) {
      this.param = bos;
   }
    ...
    * <br>
    * For unfixed size {@link ByteObjectImmutable}. {@link ByteObjectImmutable}
    * is flagged as such.
    * <br>
    * 
    ...
    * <br>
    * <br>
    * {@link ByteObjectImmutable} with variable string size will set
    * <br>
    * <br>
    * A Var char of 10 will always take the same amount of space and thus the {@link ByteObjectImmutable} is
    * deemed fixed size.
    * <br>
    * <br>
    * @param index
    ...
    * <br>
    * To read the number of values, call {@link ByteObjectImmutable#getDynNumValues(int)}
    * @param index
    * @param dest
    * @param destOffset
    * @param destLen
    ...
    * <br>
    * See {@link ByteObjectImmutable#setDynOverWriteChars(int, char[], int, int)}
    * 
    * @param index
    * @param str
    */
   ...
   public void setSub(ByteObjectImmutable bo, int index) {
      immutableCheck();
      param[index] = bo;
   }

   public void setSubIndexed(ByteObjectImmutable bo, int index, int value) {
      immutableCheck();
   ...
   public void setSubIndexed1(ByteObjectImmutable bo, int index) {
      setSubIndexed(bo, index, 1);
   }

   public void setSubIndexed2(ByteObjectImmutable bo, int index) {
      setSubIndexed(bo, index, 2);
   }

   public void setSubs(ByteObjectImmutable[] subs) {
      immutableCheck();
      this.param = subs;
   }
   ...
   /**
    * Get a copy of the {@link ByteObjectImmutable} unwrapped. Serialization of all {@link ByteObjectImmutable} in the hierarchy.
    * <br>
    * <br>
    ...
    * <br>
    * <br>
    * Created when using {@link ByteObjectImmutable#ByteObject(byte[])}
    * <br>
    * <br>
    * How do you resolve cross references? With {@link ByteObjectImmutable#getTopology()} method.
    * <br>
    * <br>
    * The opposite method is {@link ByteObjectImmutable#createByteObjectFromWrap(byte[], int)}.
    * <br>
    * <br>
    ...
    * you never know if the {@link ByteObjectImmutable} is already part of a bigger array.
    * <br>
    * Since this method is used to write this and only one {@link ByteObjectImmutable}'s data, the method cannot
   ...
   public byte[] toByteArray(ByteObjectImmutable serialDescriptor) {
      return toByteArray(null, serialDescriptor);
   }

   /**
    * Maps all the {@link ByteObjectImmutable} parameters inside the {@link IntToObjects} reference map.
    * <br>
    * <br>
    ...
    * @return
    */
   public byte[] toByteArray(IntToObjects globalrefs, ByteObjectImmutable serialDescriptor) {
      ...
      for (int i = 0; i < topology.nextempty; i++) {
         //object to serialize
         ByteObjectImmutable bo = ((ByteObjectImmutable) topology.objects[i]);
         //magic byte
         if (bo != null) {
   ...
   /**
    * ToString method called from a subclass of {@link ByteObjectImmutable}.
    * @param nl
    * @return
    */
