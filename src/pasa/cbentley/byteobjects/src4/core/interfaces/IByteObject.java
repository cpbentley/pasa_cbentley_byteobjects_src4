 ...
 * 
 * TODO rename with IBO, {@link IBOArray}
 * 
...
public interface IByteObject {
   ...
   public static final int  A_OBJECT_EX_BASIC_SIZE               = 6;
    ...
    * <br>
    * <br>
    * <li>The special type {@link IBOTypesBOC#TYPE_000_UNKNOWN}
    * <li>The special type {@link IBOTypesBOC#TYPE_004_}
    * <li>The special type {@link IBOTypesBOC#TYPE_006_LIT_NAME}
    * <li>The special type {@link IBOTypesBOC#TYPE_013_TEMPLATE}
    * <li>The special type {@link IBOTypesBOC#TYPE_015_REFERENCE_32}
    * <li>The special type {@link IBOTypesBOC#TYPE_016_REFERENCE_64}
    ...
    * 
    * <li> {@link ByteObjectManaged} is a {@link ByteObject} with an explicit class id {@link IBOAgentManaged#AGENT_OFFSET_05_CLASS_ID2}
    ...
    * 
    * A {@link IByteObject} definition with a subtype field in its header effectively makes the object final.
    */
   ...
   /**
    * 2 bytes defines the length i.e. number of bytes used by this {@link ByteObject} including the {@link IByteObject} header.
    * <br>
    * <br>
    ...
    * <br>
    * When value is {@link IByteObject#A_OBJECT_LENGTH_OVERRIDE}, it means nothing anymore.
    * <br>
    * other special values are 0,1,2,3. Length cannot be smaller than the header size {@link IByteObject#A_OBJECT_BASIC_SIZE}
    */
   public static final int  A_OBJECT_OFFSET_3_LENGTH2            = 2;

   /**
    * 2 bytes type for objects with {@link IBOTypesBOC#TYPE_001_EXTENSION} type
    */
   public static final int  A_OBJECT_EX_OFFSET_4_TYPE2           = 4;
    ...
    * 
    * {@link IByteObject#A_OBJECT_FLAG_8_TAILER}
    */
   ...
   /**
    * Magic byte for basic error detection in addition to the length header {@link IByteObject#A_OBJECT_OFFSET_3_LENGTH2}.
    * <br>
    * <br>
    * 
    */
    ...
    * <br>
    * <br>
    * {@link IByteObject#A_OBJECT_FLAG_4_SERIALIZED}
    */
