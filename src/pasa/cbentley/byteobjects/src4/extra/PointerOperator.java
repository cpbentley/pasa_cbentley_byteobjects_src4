 ...
 * <br>
 * 
 * A {@link ITechPointer} is a search request in a target {@link ByteObject} for a result
 * <li> another {@link ByteObject}
 * 
 * @author Charles Bentley
 *
 */
public class PointerOperator extends BOAbstractOperator implements ITechPointer {
   ...
   private ByteObject getPointerTarget(ByteObject pointer, ByteObject target) {
      ...
      if (pointer.hasFlag(POINTER_OFFSET_01_FLAG, POINTER_FLAG_8_FLAG_ORDERING)) {
         ...
         target = boc.getBOModuleManager().getByteObjectFlagOrdered(target, offset, flag);
      }
      return target;
   }
