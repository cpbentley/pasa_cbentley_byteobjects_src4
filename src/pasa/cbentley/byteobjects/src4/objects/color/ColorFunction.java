...
public class ColorFunction extends Function implements ITechColorFunction {
   ...
   private int randomChannelSlope(int color) {
      int mo = randDef.get2(IBOColorRnd.RND_COLORS_OFFSET_08_CHANNEL_MOD2);
      int ch = getRandom().nextInt(4);
      if (randDef.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_01_FLAG, IBOColorRnd.RND_COLORS_FLAG_6_RANDOM_MOD_CAP)) {
   ...
   private int randomColorVariation(int oldcolor) {
      int rootColor = randDef.get4(IBOColorRnd.RND_COLORS_OFFSET_07_ROOTCOLOR4);
   ...
   private int randomValuesPreset(int oldcolor) {
      ...
      boolean isRandom = randDef.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_01_FLAG, IBOColorRnd.RND_COLORS_FLAG_2_RANDOM);
      if (values != null) {
         if (isRandom) {
   ...
   public int fxRandom(int oldcolor) {
      int type = randDef.get1(IBOColorRnd.RND_COLORS_OFFSET_06_TYPE1);
      int color = oldcolor;
      switch (type) {
         ...
         case IBOColorRnd.RND_COLORS_TYPE_8_FIXEDEXTREMES:
            ...
            break;
         case IBOColorRnd.RND_COLORS_TYPE_9_FIXED_EXTREMES:
            color = randomInArray(IColorsStatic.z_128);
            break;
         case IBOColorRnd.RND_COLORS_TYPE_10_WEB:
   ...
   protected int randomGrayscale(int color) {
      ...
      int blue = val;
      int alpha = 255;
      boolean isRandomCh = !randDef.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_01_FLAG, IBOColorRnd.RND_COLORS_FLAG_7_ALL_CHANNELS_SAME);
      if (randDef.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_02_FLAGP, IBOColorRnd.RND_COLORS_FLAG_P_4_ALPHA_CHANNEL)) {
         alpha = val;
      }
      if (mo != 0) {
         if (isRandomCh) {
   ...
   private void resetChannelMode(ByteObject def) {
      if (def.hasFlag(FUN_OFFSET_03_FLAGP, FUN_FLAGP_4_CHANNELS)) {
         ...
         if (randDef != null) {
            ...
            int blend = randDef.get1(IBOColorRnd.RND_COLORS_OFFSET_09_BLEND1);
            int blendAlpha = randDef.get1(IBOColorRnd.RND_COLORS_OFFSET_10_BLEND_ALPHA1);
   ...
   private int random1Channel(int oldcolor) {
      ...
      int d = 256;
      int floor = 0;
      if (randDef.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_01_FLAG, IBOColorRnd.RND_COLORS_FLAG_8_USE_THRESHOLD)) {
         floor = def.get1(IBOColorRnd.RND_COLORS_OFFSET_04_FLOOR1);
         int ceil = def.get1(IBOColorRnd.RND_COLORS_OFFSET_05_CEIL1) + 1;
         d = ceil - floor;
         if (d < 0) {
            d = 0;
         }
      ...
      if (randDef.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_02_FLAGP, IBOColorRnd.RND_COLORS_FLAG_P_1_RED_CHANNEL)) {
         red = getRandom().nextInt(d) + floor;
      }
      if (randDef.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_02_FLAGP, IBOColorRnd.RND_COLORS_FLAG_P_2_GREEN_CHANNEL)) {
         green = getRandom().nextInt(d) + floor;
      }
      if (randDef.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_02_FLAGP, IBOColorRnd.RND_COLORS_FLAG_P_3_BLUE_CHANNEL)) {
   ...
   private int random3ChannelMod(int color) {
      int mod = randDef.get2(IBOColorRnd.RND_COLORS_OFFSET_08_CHANNEL_MOD2);
      int alpha = (color >> 24) & 0xFF;
      int red = (color >> 16) & 0xFF;
      int green = (color >> 8) & 0xFF;
      int blue = (color >> 0) & 0xFF;
      boolean isAllSame = randDef.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_01_FLAG, IBOColorRnd.RND_COLORS_FLAG_7_ALL_CHANNELS_SAME);
      if (isAllSame) {
   ...
   private int randomBlackWhiteRoot(int oldcolor) {
      int color;
      int randcap = randDef.get2(IBOColorRnd.RND_COLORS_OFFSET_10_RND_CAP2);
      if (randcap < 3) {
         randcap = 3;
      }
   ...
   public void toStringRndColor(Dctx dc, ByteObject bo) {
      ...
      int type = bo.get1(IBOColorRnd.RND_COLORS_OFFSET_06_TYPE1);
      dc.append(ToStringStaticBO.toStringRndColorType(type));
      dc.nl();
      boolean useThreshold = bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_01_FLAG, IBOColorRnd.RND_COLORS_FLAG_8_USE_THRESHOLD);
      dc.append("Use Threshold=" + useThreshold + " : [Floor,Ceil] = [" + bo.get1(IBOColorRnd.RND_COLORS_OFFSET_04_FLOOR1) + "," + bo.get1(IBOColorRnd.RND_COLORS_OFFSET_05_CEIL1) + "]");
      dc.nl();
      dc.append(" all=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_03_FLAGC, IBOColorRnd.RND_COLORS_FLAG_C_8_ALL_COLOR));
      dc.append(" c#1=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_03_FLAGC, IBOColorRnd.RND_COLORS_FLAG_C_1_COLOR));
      dc.append(" c#2=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_03_FLAGC, IBOColorRnd.RND_COLORS_FLAG_C_2_COLOR_AUX));
      dc.append(" c#3=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_03_FLAGC, IBOColorRnd.RND_COLORS_FLAG_C_3_COLOR_BG));
      dc.append(" c#4=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_03_FLAGC, IBOColorRnd.RND_COLORS_FLAG_C_4_COLOR_BORDER));
      dc.append(" color serie=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_03_FLAGC, IBOColorRnd.RND_COLORS_FLAG_C_5_COLOR_SERIE));
      dc.nl();
      dc.append("Channels alpha=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_02_FLAGP, IBOColorRnd.RND_COLORS_FLAG_P_4_ALPHA_CHANNEL));
      dc.append(" red=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_02_FLAGP, IBOColorRnd.RND_COLORS_FLAG_P_1_RED_CHANNEL));
      dc.append(" green=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_02_FLAGP, IBOColorRnd.RND_COLORS_FLAG_P_2_GREEN_CHANNEL));
      dc.append(" blue=" + bo.hasFlag(IBOColorRnd.RND_COLORS_OFFSET_02_FLAGP, IBOColorRnd.RND_COLORS_FLAG_P_3_BLUE_CHANNEL));
