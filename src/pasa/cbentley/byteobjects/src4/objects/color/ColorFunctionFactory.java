...
public class ColorFunctionFactory extends BOAbstractFactory implements ITechColorFunction, ITechFunction, IBOColorRnd {
   ...
   public ColorIterator getColorIterator(int color, ByteObject grad, int gradSize) {
      ...
      int stepSize = 1;
      int offset = 0;
      if (grad != null && grad.hasFlag(IBOGradient.GRADIENT_OFFSET_09_FLAGX1, IBOGradient.GRADIENT_FLAGX_7_GRADSIZE)) {
      ...
      if (grad == null) {
         ...
         stepSize = grad.get1(IBOGradient.GRADIENT_OFFSET_07_STEP1);
         if (grad.hasFlag(IBOGradient.GRADIENT_OFFSET_09_FLAGX1, IBOGradient.GRADIENT_FLAGX_6_OFFSET)) {
            offset = grad.get2(IBOGradient.GRADIENT_OFFSET_08_OFFSET2);
         }
         ...
         if (grad.hasFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_2_EXTERNAL_FUNCTION)) {
            ...
            if (grad.hasFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAGX_3_RAW)) {
               ...
               for (int i = 0; i < numGrads; i++) {
                  ...
                  gradd.set4(IBOGradient.GRADIENT_OFFSET_04_COLOR4, arr[count++]);
   ...
   public ByteObject getColorFunction(int a, int c, boolean alpha, boolean red, boolean green, boolean blue, int postop) {
      ...
      p.setFlag(FUN_OFFSET_03_FLAGP, ITechColorFunction.FUNCTION_FLAGP_5_ALPHA, alpha);
      p.setFlag(FUN_OFFSET_03_FLAGP, ITechColorFunction.FUNCTION_FLAGP_6_RED, red);
   ...
   public ByteObject getColorFunction(ByteObject fun, boolean alpha, boolean red, boolean green, boolean blue) {
      ...
      fun.setFlag(FUN_OFFSET_03_FLAGP, ITechColorFunction.FUNCTION_FLAGP_6_RED, red);
