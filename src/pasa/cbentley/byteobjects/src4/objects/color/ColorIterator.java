...
public class ColorIterator extends ObjectBoc implements IStringable {
   ...
   private void doSetColor(IColorSettable settable) {
      currentColor = getCurrentColor();
      settable.setColor(currentColor);
   }
    ...
    * @return
    */
   private int iteratePixel(IColorSettable settable, boolean isStep) {
      if (step == numSteps + 1) {
         return -1;
      } else {
         doSetColor(settable);
    ...
    * <br>
    * <br>
    * @param settable {@link GraphicsX} on which to set the color.
    * @return pixel counter since the beginning of the gradient iteration or -1 when finished
    */
   public int iteratePixelCount(IColorSettable settable) {
    ...
    */
   public int iteratePixelStep(IColorSettable settable) {
      return iteratePixel(settable, true);
   }
    ...
    * @param step
    */
   public void iterateSetStep(IColorSettable settable, int step) {
      this.step = step;
      doSetColor(settable);
   }
    ...
    */
   public int iterateTotalSize(IColorSettable settable) {
   ...
   public void toString(Dctx dc) {
      dc.root(this, ColorIterator.class, "@line5");
      toStringPrivate(dc);
   ...
   public void toString1Line(Dctx dc) {
      dc.root1Line(this, ColorIterator.class);
      toStringPrivate(dc);
