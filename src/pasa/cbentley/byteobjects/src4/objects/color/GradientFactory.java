 ...
 *
 */
public class GradientFactory extends BOAbstractFactory implements ITechFunction, ITechGradient {
   ...
   public  ByteObject getGradient(int[] colors, int step, int[] ratios) {
      ByteObject p = getBOFactory().createByteObject(IBOTypesDrw.TYPE_059_GRADIENT, IBOGradient.GRADIENT_BASIC_SIZE);
      p.setValue(IBOGradient.GRADIENT_OFFSET_07_STEP1, step, 1);
      p.setFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_5_INT_ARRAY, true);
   ...
   public  ByteObject getGradient(int scolor, int sec, boolean fillVert, boolean split, boolean doAlpha) {
      ...
      grad.setFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_1_SWITCH_2TYPES, fillVert);
      grad.setFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_4_USEALPHA, doAlpha);
      grad.setFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_1_FULL_LEFT, split);
      grad.setFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_2_FULL_RIGHT, split);
      return grad;
   }
   ...
   public  ByteObject getGradient(int scolor, int sec, int type, int step, ByteObject tcolor) {
      ByteObject p = getBOFactory().createByteObject(IBOTypesDrw.TYPE_059_GRADIENT, IBOGradient.GRADIENT_BASIC_SIZE);
      p.setValue(IBOGradient.GRADIENT_OFFSET_06_TYPE1, type, 1);
      p.setValue(IBOGradient.GRADIENT_OFFSET_05_CURSOR1, sec, 1);
      p.setValue(IBOGradient.GRADIENT_OFFSET_04_COLOR4, scolor, 4);
      p.setValue(IBOGradient.GRADIENT_OFFSET_07_STEP1, step, 1);
      if (tcolor != null) {
         p.addByteObject(tcolor);
         p.setFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_3_THIRD_COLOR, true);
      }
      return p;
   }
   ...
   public  ByteObject getGradient(int scolor, int sec, int type, int mainFlag, int exludeFlags, int channelFlags, ByteObject tcolor) {
      ...
      p.setValue(IBOGradient.GRADIENT_OFFSET_05_CURSOR1, sec, 1);
      p.setValue(IBOGradient.GRADIENT_OFFSET_04_COLOR4, scolor, 4);
      p.setValue(IBOGradient.GRADIENT_OFFSET_01_FLAG, mainFlag, 1);
      p.setValue(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, exludeFlags, 1);
      p.setValue(IBOGradient.GRADIENT_OFFSET_03_FLAGC_CHANNELS, channelFlags, 1);
      if (tcolor != null) {
         p.addByteObject(tcolor);
         p.setFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_3_THIRD_COLOR, true);
      }
   ...
   public void toStringGradient(ByteObject bo, Dctx sb) {
      ...
      sb.append(" scolor=" + (ToStringStaticBO.toStringColor(bo.get4(IBOGradient.GRADIENT_OFFSET_04_COLOR4))));
      sb.append(" maxSec=" + (bo.getValue(IBOGradient.GRADIENT_OFFSET_05_CURSOR1, 1)));
      sb.append(" type=" + (bo.getValue(IBOGradient.GRADIENT_OFFSET_06_TYPE1, 1)));
      sb.append(" step=" + (bo.getValue(IBOGradient.GRADIENT_OFFSET_07_STEP1, 1)));
      sb.append(" vertical=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_1_SWITCH_2TYPES)));
      sb.append(" doAlpha=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_4_USEALPHA)));
      sb.append(" artifact=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_7_ARTIFACTS)));
      sb.append(" Reverse=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_01_FLAG, IBOGradient.GRADIENT_FLAG_8_REVERSE)));
      sb.nl();
      sb.append(" fullLeft=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_1_FULL_LEFT)));
      sb.append(" fullRight=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_2_FULL_RIGHT)));
      sb.append(" leftExLeft=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_3_PART1_EXCLUDE_LEFT)));
      sb.append(" leftExRight=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_4_PART1_EXCLUDE_RIGHT)));
      sb.append(" rightExLeft=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_5_PART2_EXCLUDE_LEFT)));
      sb.append(" rightExRight=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_6_PART2_EXCLUDE_RIGHT)));
      sb.nl();
      sb.append(" a=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_03_FLAGC_CHANNELS, IBOGradient.GRADIENT_FLAGC_1_CH_A)));
      sb.append(" r=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_03_FLAGC_CHANNELS, IBOGradient.GRADIENT_FLAGC_2_CH_R)));
      sb.append(" g=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_03_FLAGC_CHANNELS, IBOGradient.GRADIENT_FLAGC_3_CH_G)));
      sb.append(" b=" + (bo.hasFlag(IBOGradient.GRADIENT_OFFSET_03_FLAGC_CHANNELS, IBOGradient.GRADIENT_FLAGC_4_CH_B)));
