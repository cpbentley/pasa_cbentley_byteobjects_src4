...
public class GradientFunction extends Function {
   ...
   /**
    * {@link IBOGradient#GRADIENT_FLAGK_3_PART1_EXCLUDE_LEFT}
    */
   boolean            isExcludeLeft;

   /**
    * {@link IBOGradient#GRADIENT_FLAGK_4_PART1_EXCLUDE_RIGHT}
    */
   ...
   /**
    * {@link IBOGradient#GRADIENT_FLAGK_1_FULL_LEFT}
    */
   boolean            isFullLeft;
   ...
   private void initColors(int primaryColor, ByteObject grad) {
      ...
      isCGreen = grad.hasFlag(IBOGradient.GRADIENT_OFFSET_03_FLAGC_CHANNELS, IBOGradient.GRADIENT_FLAGC_3_CH_G);
      isCBlue = grad.hasFlag(IBOGradient.GRADIENT_OFFSET_03_FLAGC_CHANNELS, IBOGradient.GRADIENT_FLAGC_4_CH_B);
      isCAlpha = grad.hasFlag(IBOGradient.GRADIENT_OFFSET_03_FLAGC_CHANNELS, IBOGradient.GRADIENT_FLAGC_1_CH_A);
      if (isCRed) {
   ...
   private void initPart1() {
      ...
      isFullLeft = grad.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_1_FULL_LEFT);
      isFull = isFullLeft;
      if (isFull) {
         fullColor = color_1;
      } else {
         isExcludeLeft = grad.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_3_PART1_EXCLUDE_LEFT);
         isExcludeRight = grad.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_4_PART1_EXCLUDE_RIGHT);
   ...
   private void initPart2() {
      ...
      if (isFull) {
         ...
         isExcludeLeft = grad.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_5_PART2_EXCLUDE_LEFT);
         isExcludeRight = grad.hasFlag(IBOGradient.GRADIENT_OFFSET_02_FLAGK_EXCLUDE, IBOGradient.GRADIENT_FLAGK_6_PART2_EXCLUDE_RIGHT);
