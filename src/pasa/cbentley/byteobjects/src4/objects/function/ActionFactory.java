 ...
 *
 */
public class ActionFactory extends BOAbstractFactory implements IBOAction {
   ...
   public ByteObject getActionFlagToggle(int time, ByteObject pointer) {
      if (!pointer.hasFlag(IBOPointer.POINTER_OFFSET_01_FLAG, IBOPointer.POINTER_FLAG_1_FLAG)) {
         throw new IllegalArgumentException("Flag Pointer Needed");
      }
      ByteObject p = createActionEmpty();
      p.setValue(ACTION_OFFSET_01_TYPE1, ITechAction.ACTION_TYPE_3_FLAG_TOGGLE, 1);
      p.setValue(ACTION_OFFSET_03_TIME1, time, 1);
   ...
   public ByteObject getActionFunction(int time, ByteObject pointer1, ByteObject function) {
      ...
      ByteObject p = createActionEmpty();
      p.setValue(ACTION_OFFSET_01_TYPE1, ITechAction.ACTION_TYPE_2_FUNCTION, 1);
   ...
   public ByteObject getActionSwap(int time, ByteObject pointer1, ByteObject pointer2) {
      ByteObject p = createActionEmpty();
      p.setValue(ACTION_OFFSET_01_TYPE1, ITechAction.ACTION_TYPE_1_SWAP, 1);
