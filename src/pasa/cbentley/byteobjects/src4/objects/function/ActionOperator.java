 ...
 *
 */
public class ActionOperator extends BOAbstractOperator implements IBOAction {
   ...
   public String toStringActionTime(int type) {
      switch (type) {
         case ITechAction.ACTION_TIME_1_ANIM_END:
            return "ANIM_END";
         case ITechAction.ACTION_TIME_4_ANIM_START:
            return "ANIM_START";
         case ITechAction.ACTION_TIME_3_RESET:
            return "RESET";
         case ITechAction.ACTION_TIME_2_STEP:
            return "STEP";
         default:
            return "UNKNOWN" + type;
      }
   ...
   public String toStringActionType(int type) {
      switch (type) {
         case ITechAction.ACTION_TYPE_1_SWAP:
            return "VALUE_SWAP";
         case ITechAction.ACTION_TYPE_2_FUNCTION:
            return "FUNCTION";
         case ITechAction.ACTION_TYPE_3_FLAG_TOGGLE:
            return "FLAG_TOGGLE";
         default:
            return "UNKNOWN" + type;
      }
   ...
   public void doAction(ByteObject action, ByteObject dest) {
      int type = action.get1(ACTION_OFFSET_01_TYPE1);
      switch (type) {
         case ITechAction.ACTION_TYPE_1_SWAP:
         ...
         case ITechAction.ACTION_TYPE_3_FLAG_TOGGLE:
            ...
            break;
         case ITechAction.ACTION_TYPE_4_OPERATOR:
            doActionFlagToggle(action, dest);
            break;
         default:
            break;
   ...
   public ByteObject doActionFunctor(ByteObject action, ByteObject src) {
      return doActionFunctor(action, src, action.hasFlag(ACTION_OFFSET_02_FLAG, ACTION_FLAG_1_CLONE));
   }
