...
public class Function extends ObjectBoc implements ITechFunction, IStringable {
   ...
   public void toString(Dctx dc) {
      dc.root(this, Function.class, "@line5");
      toStringPrivate(dc);
      ...
      dc.nl();
      dc.append(" postOp=" + ToStringStaticBO.toStringPostOp(postOp));
      dc.append(" indexOp=" + ToStringStaticBO.toStringCounterOp(auxOperator));
   ...
   public void toString1Line(Dctx dc) {
      dc.root1Line(this, Function.class);
      toStringPrivate(dc);
