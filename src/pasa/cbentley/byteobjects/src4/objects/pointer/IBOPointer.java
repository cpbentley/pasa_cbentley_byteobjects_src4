 ...
 *
 */
public interface IBOPointer extends IByteObject {
    ...
    * <br> {@link IBOPointer#POINTER_OFFSET_03_SIZE_OR_FLAG1} give the flag
    * <br>
    * <br>
    * 
    */
   ...
   /**
    * When the pointer requires a given type in {@link IByteObject#A_OBJECT_OFFSET_1_TYPE1}
    * <br>
    * <br>
    ...
    * <li>Order Number when looking for a Typed {@link IBOPointer#POINTER_OFFSET_04_TYPE1}
    * <li>Intra ID
    */
