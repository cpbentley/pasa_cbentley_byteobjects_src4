...
public class PointerFactory extends BOAbstractFactory implements IBOPointer {
    ...
    * <br>
    * <br>
    * @param offset {@link IBOPointer#POINTER_OFFSET_02_OFFSET2}
    * @param size {@link IBOPointer#POINTER_OFFSET_03_SIZE_OR_FLAG1}
    * @param boType {@link IBOPointer#POINTER_OFFSET_04_TYPE1}
    * @param num {@link IBOPointer#POINTER_OFFSET_05_TYPE_NUM1}
    * @return
    */
