...
import pasa.cbentley.byteobjects.core.LockManager;
 ...
 *
 */
public interface ITechObjectManaged extends ITechByteObject {

   /**
    *  This is the type used in {@link ITechByteObject#A_OBJECT_OFFSET_1_TYPE1} for all
    */
   ...
   /**
    * When {@link ITechObjectManaged#AGENT_FLAG_CTRL_4_UNPACKED}, this flag is set for the root header.
    */
    ...
    * <br>
    * <br>
    * {@link ITechByteObject#A_OBJECT_FLAG_7_IMMUTABLE} does not work because we still want to be able
    ...
    * sets the {@link ITechObjectManaged#AGENT_FLAG_CTRL_7_DATA_UNLOADED}
    ...
    * <li> {@link ITechObjectManaged#AGENT_FLAGZ_CTRL_1_REFERENCED}
    * <li> {@link ITechObjectManaged#AGENT_FLAG_CTRL_2_EXCLUSIVE}
    * <li> {@link ITechObjectManaged#AGENT_FLAGZ_CTRL_3_FROM_SOURCE}
    * <li> {@link ITechObjectManaged#AGENT_FLAG_CTRL_4_UNPACKED}
    * <li> {@link ITechObjectManaged#AGENT_FLAG_CTRL_5_ROOT}
    * <li> {@link ITechObjectManaged#AGENT_FLAG_CTRL_6_READ_ONLY}
    * 
    */
    ...
    * <br>
    * Another parallel hierarchy to instance. Matches the {@link ITechByteControler#MEMC_OFFSET_04_CTRL_GROUP_ID2}
    * <br>
    * <br>
   ...
   /**
    * Identifies the instance within the {@link ITechObjectManaged#AGENT_OFFSET_06_GSOURCE_ID2}
    * <br>
    ...
    * <br>
    * <br>
    * In case of several instance ids, the flag {@link ITechObjectManaged#AGENT_FLAGZ_CTRL_3_FROM_SOURCE} points
    ...
    * When first created, the {@link ITechObjectManaged} reference ID is unknown as zero.
    * The reference ID will be set when an {@link ITechObjectManaged} is first added to a {@link ByteController}.
    * <br>
    ...
    * {@link ITechObjectManaged#AGENT_OFFSET_16_LEN4}.
    * <br>
   ...
   /**
    * The agent data byte length. Sub length see {@link ITechByteObject#A_OBJECT_OFFSET_3_LENGTH2}
    * <br>
    * <br>
    ...
    * <br>
    * <br>
    * The  {@link ITechByteObject#A_OBJECT_OFFSET_3_LENGTH2} only records header data.
    * <br>
    * <br>
